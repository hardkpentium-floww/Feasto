...
ALLOWED_HOSTS = [
    "feasto-prod.apigateway.in",
    "feasto-alpha.apigateway.in",
    "feasto-beta.apigateway.in",
    "feasto-gamma.apigateway.in",
    "feasto-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [feasto - "+os.environ.get("STAGE", "local")+
